...
class Pose3dTransformerHead(BaseHead):
    ...
    def __init__(
        ...
        # Per-joint Laplace uncertainty parameters
        ...
        # Per-joint Laplace uncertainty attributes
        ...
        # Conditional log-scale output head for per-joint uncertainty
    ...
    def forward(
        ...
        if self.use_per_joint_uncertainty:
            ...
            # For shared_scalar: (B, 22, 1); for per_axis: (B, 22, 3)
    ...
    def loss(
        ...
        if self.use_per_joint_uncertainty:
            ...
            # s broadcasts (B,22,1) over abs_err (B,22,3) for shared_scalar mode
