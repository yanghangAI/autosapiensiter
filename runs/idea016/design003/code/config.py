...
# STAGE=2 → train300.txt, 10 epochs    (only run when stage-1 beats baseline)
...
_train_file = 'train100.txt' if _stage == 1 else 'train300.txt'
_splits = dict(
...
output_dir = "/work/pi_nwycoff_umass_edu/hang/autosapiens_iter/runs/idea016/design003"

# ── Training schedule (stage-dependent) ──────────────────────────────────────
...
# ── Optimizer (AMP via FixedAmpOptimWrapper) ─────────────────────────────────
optim_wrapper = dict(
