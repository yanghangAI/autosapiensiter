...
class Pose3dTransformerHead(BaseHead):
    ...
    def __init__(
        ...
        # Zero-init so depth signal starts at zero (equivalent to baseline at epoch 0)
    ...
    def forward(
        ...
        Args:
            ...
            depth_map: Optional ``(B, 1, H', W')`` depth tensor already
                       resized to feature map resolution. When provided,
                       a depth-aware positional signal is added to the
                       spatial tokens.
        ...
        # Depth-aware positional signal (Design A: scalar linear projection)
