...
class Pose3dTransformerHead(BaseHead):
    ...
    def __init__(
        ...
        # Learnable joint query embeddings (body queries only)
        ...
        # Linear projection for hand recovery from body features
        self.hand_proj = nn.Linear(num_body_queries * hidden_dim,
    ...
    def _init_head_weights(self) -> None:
        ...
        # Hand projection initialisation
    ...
    def forward(
        ...
        # Hand recovery via linear projection of flattened body features
