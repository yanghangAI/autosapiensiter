...
# Group index ranges for per-group EMA difficulty weighting (design003)
_UPPER_IDX = list(range(0, 13))   # 13 joints (indices 0-12)
_LOWER_IDX = list(range(13, 22))  # 9 joints (indices 13-21)
