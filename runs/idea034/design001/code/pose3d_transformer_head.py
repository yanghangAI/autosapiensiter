...
idea034 / design001 (Variant A): metric 3D PE via depth unprojection,
embedded through a 2-layer MLP and added to the spatial tokens (keys+values).
...
class Pose3dTransformerHead(BaseHead):
    ...
    def __init__(
        ...
        metric_pe_variant: str = 'mlp_additive',
        ...
        if self.use_metric_pe_3d:
            assert self.metric_pe_variant in (
                'mlp_additive', 'sinusoidal', 'keys_only'), \
